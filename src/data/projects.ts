export const projects = [
    {
      ...
      story: "Built a full-stack ML platform to help finance teams detect budget inefficiencies. Implemented anomaly detection using Random Forest + LSTM ensembles (92% accuracy).",
      architecture: {
        nodes: [
    ...
    },
    {
      ...
      story: "Engineered a scalable RAG architecture handling 10GB+ repositories with sub-200ms query responses. Integrated Stripe for subscriptions, proving full-stack SaaS capability.",
    },
    {
      id: 3,
      title: "MelodyHub",
      ...
      story: "Architected a synchronized playback engine achieving 99.2% uptime. Focused on high-concurrency performance and OOP-based backend architecture.",
    },
    {
      id: 4,
