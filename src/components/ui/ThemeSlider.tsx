...
export const ThemeSlider: React.FC<ThemeSliderProps> = ({
  ...
  const { themeState, setTimeRatio, setIsAutoMode, updateThemeFromTime } =
    useTheme();
  ...
  return (
    <div
      className={`w-full max-w-md flex flex-col items-center space-y-4 ${className}`}
    >
