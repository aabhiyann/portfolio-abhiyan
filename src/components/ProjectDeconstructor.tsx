...
const ProjectDeconstructor: React.FC<ProjectDeconstructorProps> = ({
  architecture,
  onClose,
}) => {
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-4xl h-[600px] bg-bg-primary rounded-2xl shadow-xl"
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute top-6 right-6 p-2 rounded-full hover:bg-overlay-light"
          >
            <svg
