...
This document provides a comprehensive specification for the design, structure, components, and interactions of the Abhiyan Sainju portfolio website. It merges all prior plans and technical details into one definitive reference for both designers and developers.

The goal is to ensure consistency, clarity, and scalability across the site.

### 2.2. Design Direction

The portfolio draws direction from:
...
*   **The Foundation (Minimalist Canvas):** guided by Keita Yamada, the core layout will be clean, spacious, and built on a strong grid.
*   **The Accents (Personal Story):** guided by Seán Halpin, we will layer personal, warm, and interactive elements on top.
